...
This project implements a C++ template-based matrix library for linear algebra operations, featuring multi-threaded acceleration and an automated unit test suite.
